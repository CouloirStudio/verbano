...
import styles from '../settings/styles/globalSettings.module.scss';
import classes from "../settings/styles/globalSettings.module.scss";
import { UPDATE_FULL_NAME_MUTATION } from '@/app/middleware/mutations';
...
const Profile = () => {
    ...
    const [updateFullName] = useMutation(UPDATE_FULL_NAME_MUTATION, {
        ...
        update: (cache, { data: { updateFullName } }) => {
            ...
            const userData = cache.readQuery<CurrentUserData>({ query: CURRENT_USER_QUERY });
